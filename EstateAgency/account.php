...
<body class="starter-page-page">
    ...
    $stmt->bind_param("ssss", $u_email, $u_email, $u_email, $u_email);
    $stmt->execute();
    $result = $stmt->get_result();
    ?>
                            ...
                            <div class="collapsible">
                                <ul>
                                    <?php if ($u_permission === '企業'): ?>
                                        <li><p>🏢 <strong>公司類型：</strong><?= htmlspecialchars($data['c_type']) ?></p></li>
                                        <li><p>👤 <strong>聯絡人姓名：</strong><?= htmlspecialchars($data['e_name']) ?></p></li>
                                        <li><p>💼 <strong>聯絡人職稱：</strong><?= htmlspecialchars($data['e_type']) ?></p></li>
                                        <li><p>📧 <strong>聯絡人Email：</strong><?= htmlspecialchars($data['e_email']) ?></p></li>
                                        <li><p>📞 <strong>聯絡人電話：</strong><?= htmlspecialchars($data['e_phone']) ?></p></li>
                                        <li><p>📜 <strong>公司簡介：</strong></p><p><?= nl2br(htmlspecialchars($data['u_content'])) ?></p></li>
                                    <?php elseif ($u_permission === '組織團體'): ?>
                                        <li><p>🏢 <strong>組織類型：</strong><?= htmlspecialchars($data['o_type']) ?></p></li>
                                        <li><p>👤 <strong>聯絡人姓名：</strong><?= htmlspecialchars($data['s_name']) ?></p></li>
                                        <li><p>💼 <strong>聯絡人職稱：</strong><?= htmlspecialchars($data['s_type']) ?></p></li>
                                        <li><p>📧 <strong>聯絡人Email：</strong><?= htmlspecialchars($data['s_email']) ?></p></li>
                                        <li><p>📞 <strong>聯絡人電話：</strong><?= htmlspecialchars($data['s_phone']) ?></p></li>
                                        <li><p>📜 <strong>組織簡介：</strong></p><p><?= nl2br(htmlspecialchars($data['u_content'])) ?></p></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
